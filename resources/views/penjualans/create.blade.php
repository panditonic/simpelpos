...
<style>
    ...
    .invoice-box table {
        width: 100%;
        min-width: 1000px; /* Ensure table is wide enough to require scrolling */
    ...
    .invoice-box table td {
        ...
        line-height: 1.2; /* Tighter line height to avoid extra spacing */
    ...
    .invoice-box table td:nth-child(6) {
        width: 7%; /* Harga Jual */
    }

    .invoice-box table th:nth-child(7),
    .invoice-box table td:nth-child(7) {
        width: 7%; /* Diskon (%) */
    }

    .invoice-box table th:nth-child(8),
    .invoice-box table td:nth-child(8) {
        width: 7%; /* Harga Setelah Diskon */
    }

    .invoice-box table th:nth-child(9),
    .invoice-box table td:nth-child(9) {
        width: 7%; /* Subtotal */
    }

    .invoice-box table th:nth-child(10),
    .invoice-box table td:nth-child(10) {
        width: 7%; /* Berat */
    }

    .invoice-box table th:nth-child(11),
    .invoice-box table td:nth-child(11) {
        width: 7%; /* Catatan Item */
    }

    .invoice-box table th:nth-child(12),
    .invoice-box table td:nth-child(12) {
        width: 7%; /* Laba Per Item */
    }

    .invoice-box table th:nth-child(13),
    .invoice-box table td:nth-child(13) {
        width: 7%; /* Aksi */
    }
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="h-100 d-flex flex-column">
                                ...
                                <div class="mb-3 flex-grow-1">
                                    ...
                                    <textarea name="catatan" id="catatan" class="form-control h-100" rows="3" placeholder="Catatan tambahan...">{{ old('catatan') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="h-100 d-flex flex-column">
                                ...
                                <div class="mb-3 flex-grow-1">
                                    ...
                                    <textarea name="alamat_pelanggan" id="alamat_pelanggan" class="form-control h-100" rows="3" placeholder="Alamat lengkap pelanggan...">{{ old('alamat_pelanggan') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <tr class="produk-item">
                            ...
                            <td>
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="produks[0][harga_modal]" class="harga-modal" value="{{ old('produks.0.harga_modal', 0) }}">
                                </div>
                            </td>
                            <td>
